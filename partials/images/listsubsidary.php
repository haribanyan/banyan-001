...
<table class="tle"   style="font-family: poppins;border-collapse: collapse;width: 200%;" >
  <tr>
	...
	<th  style="border: 1px solid #dddddd;text-align: left;padding: 8px;"><b>Subsidary Amount</b></th>
        <th  style="border: 1px solid #dddddd;text-align: left;padding: 8px;" ><b>Status</b></th>
        ...
        <td  style="border: 1px solid #dddddd;text-align: left;padding: 8px;"id="status_sub"> </td>
          ...
          <form class="form-horizontal" id="userForm2" method="post" novalidate="novalidate">
                <div class="ibox-body control-group" >
					...
					<div class="form-group row">
                        <label class="col-sm-2 col-form-label">Subsidary Status </label>
                        <div class="col-sm-6">
                             <select class="form-control" name="status" id="statussub" style="font-family:Poppins;height:40px" placeholder="status">
                    ...
                    <div class="ibox-head" >
                        <div class="ibox-title">
                           <!-- <select style="font-family: Poppins" id="customer_status">
								...
								<span><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Order Id,Customer Nmae.." title="Type in a name" style="font-family:poppins;width:250px"></span>
                ...
                $('#Editsubs').val(data[0].subs_id);
                 $('#subamt').val(data[0].sub_amt);
					...
					//$('#chenum').val('8383838');
					 ...
					 $('#padate').val(data[0].pay_date);
					  
                    $('#paype').val(data[0].pay_type);
					 $('#statussub').val(data[0].status); 
