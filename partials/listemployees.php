 ...
 <div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="col-sm-10 ml-sm-auto">
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary" onclick="userAction('add');">Add Employees</a>
                    </div>
                </div>
            </form>
        </div>
...
<p id="emp_phoneno"></p>
<p id="emp_email"></p>
<table><tr><td>Designation</td><td id="emp_salary"></td></tr></table>
</div>
                        </div>
                        <br>
...
//alert(pagenum);
   $("#userData").load("partials/pagination_data.php?page=" + pagenum +"&status="+ status);
...
call(pageNum,status);
   ...
   $("#userData").load("partials/pagination_data.php?page=1&status=", Hide_Load());
   //Pagination Click
...
//alert(userData);
            ...
            $.ajax({
                ...
                success: function (msg) {
                    console.log(msg);
                    if (msg == 'ok') {
                        alert('Employee has been ' + statusArr[type] + ' successfully.');
                        getUsers();
                        $('#userForm1')[0].reset();
                        //$('#addForm').hide();
