...
if (isset($_POST['action_type']) && !empty($_POST['action_type'])) {
    if ($_POST['action_type'] == 'data') {
        $conditions['where'] = array('supplier_id' => $_POST['id']);
...
echo '<td>' . $user['emp_phoneno'] . '</td>';
  ...
  $count=$sql;
     ...
     if ($count > 0) {
        ...
        if (!empty($_POST['id'])) {
            $conditions = array('supplier_id' => $_POST['id']);
...
$date=date("Y-m-d H:i:s");
        $userData = array(
            'supplier_cmpny_name' => $_POST['cname'],
            'supplier_contact_person' => $_POST['cpname'],
            'supplier_email' => $_POST['email'],
            'supplier_phone' => $_POST['phone'],
            'supplier_address' => $_POST['address'],
'supplier_city' => $_POST['city'],
'supplier_state' => $_POST['state'],
'supplier_pincode' => $_POST['pincode'],
            'supplier_gst' => $_POST['GST'],
            'supplier_pan' => $_POST['pan'],
            'supplier_created_on' => $date,
            'supplier_updated_on' => $date,
...
'supplier_pincode' => $_POST['pincode'],
            ...
            $condition = array('supplier_id' => $_POST['id']);
